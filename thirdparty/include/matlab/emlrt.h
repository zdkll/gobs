 ...
 */
#define EMLRT_VERSION_R2017A 0x2017A
#define EMLRT_VERSION_INFO  EMLRT_VERSION_R2017A
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtReturnArrays(const int32_T aNlhs, mxArray *aLHS[], const mxArray *const aRHS[]);

/*
 * MATLAB INTERNAL USE ONLY :: Protect mxArray from being overwritten if necessary
 */
EXTERN_C LIBEMLRT_API const mxArray *emlrtProtectR2012b(const mxArray *pa, int32_T , boolean_T , int32_T reservedNumEl);

/*
 * MATLAB INTERNAL USE ONLY :: License check
 */
EXTERN_C LIBEMLRT_API void emlrtLicenseCheckR2012b(emlrtCTX aTLS, const char *aFeatureKey, const int32_T b);
 ...
 * MATLAB INTERNAL USE ONLY :: Add a field to a struct matrix mxArray
 */
EXTERN_C LIBEMLRT_API const mxArray *emlrtAddField(const mxArray *mxStruct, const mxArray *mxField, const char *fldName, int32_T index);

/*
* MATLAB INTERNAL USE ONLY :: Set the value from propValues of all properties in propNames of a class instance mxArray.
*/
EXTERN_C LIBEMLRT_API void emlrtSetAllProperties(emlrtConstCTX aTLS, const mxArray **mxClass, int32_T aIndex, int32_T propCount,
                                                 const char **propNames, const char** propClasses, const mxArray** propValues);

/* 
* MATLAB INTERNAL USE ONLY :: Get the value mxArray of all properties of a class instance mxArray.
*/
EXTERN_C LIBEMLRT_API void emlrtGetAllProperties(emlrtConstCTX aTLS, const mxArray *mxCls, int32_T aIndex, int32_T propCount,
                                                 const char **propNames, const char **propClasses, const mxArray** propValues);

/*
* MATLAB INTERNAL USE ONLY :: Get the redirect target MCOS instance mxArray of a redirect source MCOS instance mxArray.
*/
EXTERN_C LIBEMLRT_API const mxArray *emlrtConvertInstanceToRedirectTarget(emlrtConstCTX aTLS, const mxArray *mxCls, int aIndex, const char* className);

/*
* MATLAB INTERNAL USE ONLY :: Get the redirect source MCOS instance mxArray of a redirect target MCOS instance mxArray.
*/
EXTERN_C LIBEMLRT_API const mxArray *emlrtConvertInstanceToRedirectSource(emlrtConstCTX aTLS, const mxArray *mxCls, int aIndex, const char* className);

/*
 * MATLAB INTERNAL USE ONLY :: Get a field from a struct matrix mxArray
 */
EXTERN_C LIBEMLRT_API const mxArray *emlrtGetFieldR2013a(emlrtConstCTX aTLS, const mxArray *mxStruct, int32_T aIndex, const char *fldName);

/*
 * MATLAB INTERNAL USE ONLY :: Set field value in structure array, given index and field name
 */
EXTERN_C LIBEMLRT_API void emlrtSetField(mxArray *mxStruct, int32_T aIndex, const char *fldName, mxArray *mxValue);
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *emlrtSetCell(const mxArray *mxCellArray, int32_T aIndex, const mxArray *mxCell);

/*
 * MATLAB INTERNAL USE ONLY :: Get a cell element
 */
EXTERN_C LIBEMLRT_API const mxArray *emlrtGetCell(emlrtConstCTX aTLS, const emlrtMsgIdentifier *aMsgId, const mxArray *mxCell, int32_T aIndex);
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *emlrtCreateFIR2013b(emlrtConstCTX aTLS, const mxArray *fimath, const mxArray *ntype, const char *fitype, const mxArray *fival, const boolean_T fmIsLocal, const boolean_T aForceComplex);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtForLoopVectorCheckR2012b(real_T start, real_T step, real_T end, mxClassID classID, int32_T n, emlrtRTEInfo *aInfo, emlrtConstCTX aTLS);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtHeapMemCheckInitialize(emlrtCTX aTLS, int32_T aMaxHeapSize);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtHeapReferenceStackLeaveScope(emlrtConstCTX aTLS, int32_T aAllocCount);
 ...
 */
EXTERN_C LIBEMLRT_API int32_T emlrtGetEntryPointIndexR2016a(emlrtConstCTX aTLS, int32_T nrhs, const mxArray *prhs[], const char *aEntryPointNames[], int32_T aNumEntryPoints);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtErrorWithMessageIdR2012b(emlrtConstCTX aTLS, const emlrtRTEInfo *aInfo, const char *aMsgID, int32_T aArgCount, ...);

/*
 * MATLAB INTERNAL USE ONLY :: Error with given message ID and args.
 */
EXTERN_C LIBEMLRT_API void emlrtErrMsgIdAndTxt(emlrtCTX aTLS, const char *aMsgID, int32_T aArgCount, ...);
 ...
 */
EXTERN_C LIBEMLRT_API mxArray* emlrtLocationLoggingPullLog(const char* const MexFileName, boolean_T pullCompReportFromMexFunction);
 ...
 * MATLAB INTERNAL USE ONLY :: Save LocationLogging Info
 */
EXTERN_C LIBEMLRT_API void emlrtLocationLoggingPushLogR2017a(const emlrtLocationLoggingFileInfoType* const fileInfo,
                                                             const emlrtLocationLoggingFunctionInfoType* const functionInfoTable,
                                                             const emlrtLocationLoggingDataType* const dataTables,
                                                             const emlrtLocationLoggingLocationType* const locationTables,
                                                             const int32_T* numFieldsTables,
...
/*
* MATLAB INTERNAL USE ONLY :: Check the class of an mxArray pa to be exactly aClassName, otherwise error out using aMsgId and aTLS.
*/
EXTERN_C LIBEMLRT_API void emlrtCheckMcosClass2017a(emlrtConstCTX aTLS, const emlrtMsgIdentifier *aMsgId, 
                                                const mxArray *pa, const char *aClassName);
/*
...
/* 
 * MATLAB INTERNAL USE ONLY :: Record time (mex profile) 
 */
EXTERN_C LIBEMLRT_API void emlrtRecordTime(int32_T);

/*
 * MATLAB INTERNAL USE ONLY :: Get time elapsed (mex profile) 
 */
EXTERN_C LIBEMLRT_API real_T emlrtGetTimeElapsed(void);

/* 
 * MATLAB INTERNAL USE ONLY :: Get time of a location (mex profile) 
 */
EXTERN_C LIBEMLRT_API real_T emlrtGetLocationTime(int32_T index);

/* 
 * MATLAB INTERNAL USE ONLY :: Get coverage hit (mex profile) 
 */
EXTERN_C LIBEMLRT_API uint32_T emlrtGetCoverageHits(int32_T index);

/* 
 * MATLAB INTERNAL USE ONLY :: Record time (mex profile) 
 */
EXTERN_C LIBEMLRT_API int32_T emlrtRecordTimeBasicBlock(void);

/* 
 * MATLAB INTERNAL USE ONLY :: Record time (mex profile)
 */
EXTERN_C LIBEMLRT_API boolean_T emlrtIsGetLocTimeEmpty(void);

/*
 * MATLAB INTERNAL USE ONLY :: A JIT Debug helper function
 */
EXTERN_C LIBEMLRT_API void emlrtJITDebugger(void *);

/*
 * MATLAB INTERNAL USE ONLY :: Turn Mex Profiling on and off
 */
EXTERN_C LIBEMLRT_API void emlrtMEXProfilingToggle(const char * aMexFile, int32_T statusValue, int32_T numInstrPoints);

EXTERN_C LIBEMLRT_API void emlrtMEXProfilingFunctionEntry(const char * aFcnName);

EXTERN_C LIBEMLRT_API void emlrtMEXProfilingFunctionExit(const char * aFcnName);

EXTERN_C LIBEMLRT_API void emlrtMEXProfilingStatement(const char * aPath, int32_T aLineNumer, int32_T aColumNumber);

/*
 * MATLAB INTERNAL USE ONLY :: Report a detected CUDA runtime error
 */
EXTERN_C LIBEMLRT_API void emlrtCUDAError(uint32_T errcode, const char *ename, const char *emsg, const emlrtRTEInfo *aInfo, emlrtConstCTX aTLS);
